	...
	<div class="sidebar-menu">
		<div class="menu">
			<ul id="menu">
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Gestion Produit</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="../../abdou/views/ajouterProduit.php">Ajouter Produit</a>
						</li>
						<li id="menu-academico-boletim"><a href="../../abdou/views/afficherProduit.php">Afficher Produit</a>
						</li>
					</ul>
				</li>
				<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Gestion Categorie</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="../../abdou/views/ajoutCategorie.php">Ajout Categorie</a>
						</li>
						<li id="menu-academico-boletim"><a href="../../abdou/views/ajoutCategorie.html">Afficher categorie</a>
						</li>
					</ul>
				</li>
			...
			<tr>
				...
				<td>
					...
					<form method="POST" action="supprimerEmploye.php">
						<input type="submit" name="supprimer" value="supprimer" class="btn btn-outline-danger" style="float: right;">
						<input type="hidden" value="<?PHP echo $row['cin']; ?>" name="cin">
					</form>
				</td>
				<td><a href="modifierEmploye.php?cin=<?PHP echo $row['cin']; ?>">
	<input type="submit" name="Modifier" value="Modifier" class="btn btn-outline-dark"></a>
				</td>
...
<table class="table">
	<tr>
	<td width="53%">	
<form action="verifform.php" method="get" class="crud">
Rechercher Employe
...
<td width="28%">
		...
		<input type="submit" name="Affecter" value="Affecter Employes aux Rendez-vous" class="btn btn-link" />
		</form>
 
	</td>
		<td><a href="consulter.php">
	<input type="submit" name="consulter" value="Consulter Charge" class="btn btn-outline-warning"></a>
				</td>
