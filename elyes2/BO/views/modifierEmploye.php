...
<tr>
<td>CIN</td>
<td><input type="number" name="cin" id="cin" required value="<?PHP echo $cin ?>" style="border-radius: 12px"></td>
	<td><span id="misscin"></span><br></td>
</tr>
<tr>
<td>Nom</td>
<td><input type="text" name="nom" id="nom" required value="<?PHP echo $nom ?>" style="border-radius: 12px"></td>
	<td><span id="missnom"></span><br></td>
</tr>
<tr>
<td>Prenom</td>
<td><input type="text" name="prenom" id="prenom" required value="<?PHP echo $prenom ?>" style="border-radius: 12px"></td>
	<td><span id="missprenom"></span><br></td>
</tr>
	<tr>
<td>Image</td>
<td><input type="file" name="image" id="image" required value="<?PHP echo $image ?>" style="border-radius: 12px"></td>
	<td><span id="missimage"></span><br></td>
</tr>
<tr>
<td>nb heures</td>
<td><input type="number" name="nbH" id="nbH" required value="<?PHP echo $nbH ?>" style="border-radius: 12px"></td>
	<td><span id="missnbH"></span><br></td>
</tr>
<tr>
<td>tarif horaire</td>
<td><input type="text" name="tarifH" id="tarifH" required value="<?PHP echo $tarifH ?>" style="border-radius: 12px"></td>
	<td><span id="misstarifH"></span><br></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
	$employe=new employe($_POST['cin'],$_POST['nom'],$_POST['prenom'],$_POST['image'],$_POST['nbH'],$_POST['tarifH'],$_POST['salaire']);
	$employeC->modifierEmploye($employe,$_POST['cin_ini']);
	echo $_POST['cin_ini'];
	echo '<script language="Javascript">
           <!--
                 document.location.replace("afficherEmploye.php");
           // -->
     </script>';
}
?>
