...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT IDrdv, nomClient,prenomClient,soin ,date FROM rendezvous WHERE nomClient LIKE ?&");
  ...
  while($terme_trouve = $select_terme->fetch())
  {
  	  ?>  <div class="element" id="columns" style="padding-left: 250px" >
                            ...
                            <figure>
                                       ...
                                       <div  ><?php echo $terme_trouve['prenomClient']; ?></div>
                                       <div  ><?php echo $terme_trouve['soin']; ?></div>
                                       <div  ><?php echo $terme_trouve['date']; ?></div>
                                </figure>     
