...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT titre, deb,fin,cap ,des,image FROM date_test WHERE titre LIKE ? OR des LIKE ?");
...
#columns:hover figure:not(:hover) {
 ...
 <body>
                  ...
                  <div class="search">
                     <form action = "verifform_front.php" method = "get" charset="utf-8">
