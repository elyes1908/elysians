...
<div class="container">
     <h2>PEvents</h2>
     <p>Modification des événements :</p>          
<div class="form-row">
...
<div class="form-group col-md-6">
    ...
    <span  id="missid" class="resultat"></span>
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="number" class="form-control" name="cap" id="cap"  onblur="verifierCap(this)" value="<?PHP echo $cap ?>">
...
<div class="form-group col-md-6">
	<label for="deb">date debut</label>
    <input type="date" class="form-control" name="deb" id="deb"  value="<?PHP echo $deb?>">
...
<tr>
<td><input type="file" name="image"></td><br><br>
</tr>
...
<center>
<div class="col-sm-10" >
<button class="btn btn-primary" type="submit"  id="modifier" name="modifier" value="modifier"> modifier </button>
</div>

</center>

<input type="hidden" name="id_event_ini" value="<?PHP echo $_GET['id'];?>">
...
<script> 
      ...
      var deb=document.getElementById('deb_p');
      var missdeb = document.getElementById('missdeb');


      var fin=document.getElementById('fin_p');
      ...
      //formValid.addEventListener('click', verifierTaux);
...
function verifierCap(champ)
  {
     ...
     if(champ.value>100)
     {
      surligne_2(champ,true);
       misscap.textContent = 'Remise ne peut pas depasser 100%';
     ...
     {
      surligne_2(champ,true);
       misscap.textContent = 'Remise ne peut pas etre inferieure à 10%';
       misscap.style.color = '#ffcc00';
...

{
    ...
    $event=new event($id,$titre,$d,$f,$cap,$des,$image);
	$eventC->modifierEvent($event,$_POST['id_event_ini']);
	echo $_POST['id_event_ini'];
	echo '<script language="Javascript">
           <!--
                 document.location.replace("afficherEvent.php");
           // -->
     </script>';
 }
