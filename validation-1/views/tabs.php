								...
								<div class="head-t">
									...
									<div class="header_right">
										...
										<div class="create_btn">
											<a href="afficherPromo.php">Affichage</a>
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
							        ...
							        <li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Marketingr</span> <span class="fa fa-angle-right" style="float: right"></span></a>

										 <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="tabs.php">Solde</a></li>
											<ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="tabs.php">Solde/a></li>
...
<div class="form-group col-md-6">
    <label for="date fin">Remise</label>
