...
foreach($listeProduit as $row){
	...
	<input type="hidden" value="<?PHP echo $row['reference']; ?>" name="reference" class="btn btn-primary">
	</form>


<form method="POST" action="affecter_solde.php">
	<input type="submit" name="affecter" value="affecter" class="btn btn-primary">
	<input type="hidden" value="<?PHP echo $row['reference']; ?>" name="reference" class="btn btn-primary">
	</form>


	<a href="modifierProduit.php?reference=<?PHP echo $row['reference']; ?>" class="btn btn-primary">
	Modifier</a></td>
	</tr>
			...
			<ul id="menu">
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Gestion Produit</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="ajoutProduit.html">Ajouter Produit</a>
						</li>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Gestion Categorie</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="ajoutCategorie.php">Ajout Categorie</a>
						</li>
						<li id="menu-academico-boletim"><a href="afficherCategorie.php">Afficher categorie</a>
						</li>
					</ul>
				</li>
				...
				<li id="menu-academico"><a href="afficherEmploye.php"><i class="fa fa-table"></i> <span> Employes</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="../../BO/views/afficherEmploye.php">Afficher les employes</a>
						</li>
						<li id="menu-academico-avaliacoes"><a href="../../BO/views/ajoutEmployeP.php">Ajouter employes</a>
						</li>
					</ul>
				</li>
