...
<div class="container">
	...
	<div class="header-top">
		...
		<div class="col-sm-5 col-md-offset-2  header-login">
					<ul >
						<li><a href="../views/auth.html">Connexion</a></li>
...
<div class="search-content">
                                        <form action = "verifform_front.php" method = "get">
                                     ...
                                     <div class="fb-page" data-href="https://www.facebook.com/CoeurDeMarieBeautyLounge/" data-tabs="timeline" data-width="1500" data-height="350" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/CoeurDeMarieBeautyLounge/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/CoeurDeMarieBeautyLounge/">Coeur de Marie Beauty Lounge</a></blockquote></div>

<div class="container">
    <br> 
    <br>
     <h2>Évènements qui pourraient vous intéresser</h2>  
     <br>
     <br>        
	 <table class="table table-striped">
		...
		?>
			...
			<script>  
            var spancap = document.getElementById('spancap');

            <?php if ($row['cap']==0 ) 
            {
?>
           
          $row['cap'].style.color = 'red';
       <?php 
   } ?>
		    ...
		    <td><img src="../images/<?php echo $row['image'];?>" alt="" style="height="500" width="500">
			<td><form method="POST" action="../views/participation.php">
			<input type="submit" name="participer" value="participer" id="btn1" 
			<?php 
              //$listeEvent=$event1C->trouver($row['id']);

			if ($row['cap']==0 OR $row['fin']<$today OR $event1C->trouver($row['id'],$_SESSION['n'])>0 )
			 { ?> disabled  <?php  } ?> >
			...
			<td><form method="POST" action="../views/ignorer.php">
			<input type="submit" name="ignorer" value="JE ne participe plus" id="btn1" 
			<?php 
              //$listeEvent=$event1C->trouver($row['id']);

			if ($event1C->trouver($row['id'],$id_membre)==0 )
			 { ?> disabled  <?php  } ?> >
			...
			<td><form method="POST" action="../views/afficherParticipant.php">
	...
	<div class="footer-middle">
			...
			<div class="footer-bottom">
				<div class="container">
					...
					<p class="footer-class">&copy; 2016 Coeur de Marie. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
					<div class="clearfix"> </div>
				</div>
			</div>
		</div>
