...
<label>Marque</label>
 <select name="marque" style="border-radius: 5px;width: 30% " id="marque" required>
					
						<option>nike</option>
						<option>Adidias</option>
					</select><span id="missmarque"></span><br>
			</div>
 <div class="form-group">
<label>Prix</label>
...
if (isset($_POST['modifier'])){
	$produit=new produit($_POST['reference'],$_POST['nom'],$_POST['categorie'],$_POST['marque'],$_POST['prix'],$_POST['quantite'],$_POST['image']);
