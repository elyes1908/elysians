				...
				<div class="header_bg">
							...
							<div class="clearfix"> 
								...
								<div class="create_btn">
											...
											<a href="affecter_solde.php">Affecter Solde </a>
								</div>
...
<div class="container">
	 ...
	 <table class="table table-striped">
		...
		?>
			...
			<td><?PHP echo $row['deb_p']; ?></td>
			<td><?PHP echo $row['fin_p']; ?></td>
			...
			<input type="hid_promoden" value="<?PHP echo $row['id_promo']; ?>" name="id_promo">
			...
			<td><a href="modifierPromo.php?id_promo=<?PHP echo $row['id_promo']; ?>">
			Modddifier</a></td>

		
			
     	<td><img src="../images/<?php echo $row['image'];?>" alt="" style="border-radius:40%;width: 30%"></td>
