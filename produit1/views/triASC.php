...
<div class="banner-top">
	...
	<?PHP
		...
		$listeProduit=$produit1C->tri_asc();
	?>
		<div class="product">
			<div class="container">
			<div class="col-md-9">
	...
	<div class="col-md-4 item-grid1 simpleCart_shelfItem">
		<div class=" mid-pop">
			<div class="pro-img">
				...
				<div class="women-top"> <?PHP echo $row['categorie']; ?> <br>Quantité: <?PHP echo $row['quantite'];?> 	<div class="clearfix"></div></div>
				<div class="img item_add">
								
				<div class="mid1">
								<p ><label><?PHP echo $row['prix']; ?> DT</p>							
								<div class="clearfix"></div>
							</div>
					<a href="#"><img src="images1/ca.png" alt=""></a>
							</div>
				<div class="clearfix"></div>
</div></div></div>
...
?>
		...
		<div class=" rsidebar span_1_of_left">
	  					  ...
	  					  <h4 class="cate" >Tri</h4>
							 <ul class="menu-drop">
							   <strong><a style="color: black" href="triASC.php"> Prix Croissant </a></strong>
							   <br><strong><a style="color: black" href="triDEC.php">Prix décroissant</a></strong>
		...
		<div class=" rsidebar span_1_of_left">
	  					  ...
	  					  <h4 class="cate" >Categories</h4>
							 <ul class="menu-drop">
							   <strong><a style="color: black" href="afficherProduitfront.php"> Tout </a></strong>
							   <br><strong><a style="color: black" href="afficherProduitH.php">Corps</a></strong>
							   <br><strong><a style="color: black" href="afficherProduitF.php">Cheveux</a></strong>
								<br><strong><a style="color: black" href="afficherProduitE.php">Visage</a></strong>
