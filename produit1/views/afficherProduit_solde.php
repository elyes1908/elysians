...
<div class="banner-top">
	...
	<?PHP
	   ...
	   {
		   $listeProduit=$db->query("SElECT * From produit where categorie='corps' ");
	   }
			 	else   if(isset($_POST['filtreV']))
	   {
		   $listeProduit=$db->query("SElECT * From produit where categorie='visage' ");
	   }
	 	else   if(isset($_POST['filtreCH']))
	   {
		   $listeProduit=$db->query("SElECT * From produit where categorie='cheveux' ");
	   }
	   else $listeProduit=$produit1C->afficherProduits_soldes();
	...
	<div class="col-md-3 product-bottom">
			...
			<div class=" rsidebar span_1_of_left">
				...
				<h4 class="cate" ><a href="afficherProduitfront.php"  style="color: brown">Tri</a></h4>
							 <ul class="menu-drop">
	  					  ...
	  					  <h4 class="cate" ><a href="afficherProduitfront.php"  style="color: brown">Catégorie</a></h4>
							 <ul class="menu-drop">
							  ...
							  <button type="submit" style="background-color:transparent" name="filtreC" value="Prix Croissant" >Corps</button><br>
								<button type="submit" style="background-color:transparent" name="filtreV" value="Prix décroissant">Visage</button><br>
								 <button type="submit" style="background-color:transparent" name="filtreCH" value="Prix Croissant" >Cheveux</button>
...
foreach($listeProduit as $row){
	...
	<div class="col-md-4 item-grid1 simpleCart_shelfItem">
		<div class=" mid-pop">
			<div class="pro-img">
				<div class="pro-img">
						<img src="../images/<?PHP echo $row['image']; ?>"  height="200px" width="250px">
						<div class="zoom-icon ">
	           ...
	           <div class="clearfix"></div>
				...
				<div class="mid1">
								<p ><label><?PHP echo $row['prix']; ?> DT</p>	</label>						
								<div class="clearfix"></div>
