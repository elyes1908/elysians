...
<tr>
<td>ID</td>
<td><input type="text" name="idC" value="<?PHP echo $idC ?>" style="border-radius: 5px; width: 30% "required ><span id="missid"></span></td>
</tr>
</div>
 <div class="form-group">
<tr>
<td>Nom</td>
<td> <input type="text"  name="nomC" style="border-radius: 5px; width: 30% " id="nomC" value="<?PHP echo $nomC ?>" required> <span id="missnomC"></span>
...
<tr>
<td></td>
<td><input type="submit" name="modifier" value="modifier" class="btn btn-primary" id="bouton_modif"></td>
</tr>
</div>
 <div class="form-group"> </div>
<tr>
<td></td>
<td><input type="hidden" name="ref-ref" value="<?PHP echo $_GET['idC'];?>" ></td>
</tr>
...
if (isset($_POST['modifier'])){
	$categorie=new categorie($_POST['idC'],$_POST['nomC']);
	$categorieC->modifierCategorie($categorie,$_POST['ref-ref']);
	echo $_POST['ref-ref'];
...
<script> var formValid = document.getElementById('bouton_envoi');
