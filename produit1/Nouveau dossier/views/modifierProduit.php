...
<tr>
<td>Categorie</td>
<td><input type="text" name="categorie" value="<?PHP echo $categorie ?>" style="border-radius: 5px; width: 30% "required ></td>
</tr>
</div>
 <div class="form-group">
<tr>
...
<tr>
<td>Image</td>
<td><input type="file" name="image" accept="image/jpg,image/png"> value="<?PHP echo $image ?>"></td>
</tr>
</div>
 <div class="form-group">
<tr>
...
<tr>
<td></td>
<td><input type="hidden" name="ref-ref" value="<?PHP echo $_GET['reference'];?>" ></td>
</tr>
...
if (isset($_POST['modifier'])){
	$produit=new produit($_POST['reference'],$_POST['nom'],$_POST['categorie'],$_POST['prix'],$_POST['quantite'],$_POST['image']);
	$produitC->modifierProduit($produit,$_POST['ref-ref']);
	echo $_POST['ref-ref'];
