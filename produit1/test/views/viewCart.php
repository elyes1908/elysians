...
<link href="css1/form.css" rel="stylesheet" type="text/css" media="all" />
    <script>
    function updateCartItem(obj,reference){
        $.get("../core/cartAction.php", {action:"updateCartItem", reference:reference, qty:obj.value}, function(data){
            if(data == 'ok'){
...
<ul>
			...
			<li><a class="color4" href="map.html">Localisation</a></li>
...
<div class="container">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="../core/cartAction.php?action=removeCartItem&reference=<?php echo $item["rowid"]; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash"></i></a>
            </td>
        </tr>
        <?php } }else{ ?>
    ...
    <tfoot>
        <tr>
            <td><a href="../../views/afficherProduitfront.php" class="btn btn-warning"><em class="glyphicon glyphicon-menu-left"></em> Continuer vos achats</a></td>
            <td colspan="2"></td>
            <?php if($cart->total_items() > 0){ ?>
            <td class="text-center"><strong>Total <?php echo $cart->total() .' Dt'; ?></strong></td>
            <td>
                <form method="post" action="fidelite.php">
                   <input type="submit" class="btn btn-success btn-block" value="Check-out"> <i class="glyphicon glyphicon-menu-right"></i>
                </form>
            </td>
            <?php } ?>
        </tr>
