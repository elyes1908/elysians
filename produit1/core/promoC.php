...
function reduction($id,$nouv,$id_promo)
    {
  
			$sql2="UPDATE produit  SET produit.prix_solde=$nouv WHERE produit.reference=$id";
			$sql3="UPDATE produit SET produit.id_promo=$id_promo WHERE produit.reference=$id";
		//	$sql="UPDATE produit SET produit.fin_p=$fin WHERE produit.reference=$id";
...
/*******************************************************************/
function reduction_non($id)
    {
  
			$sql2="UPDATE produit  SET produit.prix_solde= NULL WHERE produit.reference=$id";
			$sql3="UPDATE produit  SET produit.id_promo= NULL WHERE produit.reference=$id";
