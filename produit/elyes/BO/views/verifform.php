...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT nom, prenom,nbHeures,tarifHoraire,image,cin  FROM employe WHERE nom LIKE ?");
  ...
  while($terme_trouve = $select_terme->fetch())
  {
  	  ?>  <div class="element" id="columns" style="padding-left: 250px" >
                            ...
                            <figure>
                                       ...
                                       <div  ><?php echo $terme_trouve['nbHeures']." H"; ?></div>
								<div  ><?php echo $terme_trouve['tarifHoraire'] ." Dt/H"; ?></div>
								<div  ><img src="../../FO/images/<?php echo $terme_trouve['image'];?>" alt="" style="border-radius:70%"></div>
				...
				<table>
				<td><a href="modifierEmploye.php?cin=<?PHP echo $terme_trouve['cin']; ?>">
