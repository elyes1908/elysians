...
<body>
	<?php
				...
				<tr>
					...
					<td>
						<?php echo $row['disponibilite'];?>
					</td>
					<td>
						<a href="employe.php?edit=<?php echo $row['id']; ?>" class="btn btn-info"> Edit</a>
...
<div class="banner-top">
    <div class="container">
        <h1>Produits Pour Cheveux</h1>
        <em></em>
        <h2><a href="index.html">Accueil</a><label>/</label>Produits Pour Cheveux</h2>
    </div>
</div>
<!--content-->
<div class="product">
    <div class="container">
        ...
        <div class="col-md-3 product-bottom">
            ...
            <div class=" rsidebar span_1_of_left">
                ...
                <ul class="menu-drop">
                    <li class="item1"><a href="#">Hommes </a>
                        <ul class="cute">
                    ...
                    <li class="item2"><a href="#">Femmes </a>
                        <ul class="cute">
                            <li class="subitem1"><a href="product.html">Cute Kittens </a></li>
                            <li class="subitem2"><a href="product.html">Strange Stuff </a></li>
                            <li class="subitem3"><a href="product.html">Automatic Fails </a></li>
