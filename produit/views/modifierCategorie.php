...
<tr>
<td>ID</td>
<td><input type="text" name="idC" value="<?PHP echo $idC ?>" style="border-radius: 5px; width: 30% "required ></td>
</tr>
</div>
 <div class="form-group">
<tr>
<td>Nom</td>
<td> <input type="text"  name="nomC" style="border-radius: 5px; width: 30% " id="nomC" value="<?PHP echo $nomC ?>" required>
